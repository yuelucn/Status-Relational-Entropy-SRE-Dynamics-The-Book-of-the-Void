# Second Operator (Local Metric & Probabilistic Pruning Operator $\mathcal{M}_\chi \circ \mathcal{E}_{\text{local}}$)
...
---
## 11. P0 Emergency Revision: Derivation of Explicit Topological‑Weight $w_\alpha$ and its SRE Statistical‑Mechanical Origin
...
---
## 13. Asymptotic Extremes and Boundary Analysis
### 13.1 Coupling Constant $\lambda \to 0$ (Zero‑Dissipation Crystallization Boundary)
$$
...
### 13.2 Coupling Constant $\lambda \to \infty$ (Infinite‑Dissipation Heat‑Death Boundary)
$$
